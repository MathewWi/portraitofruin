...
gui.register(function()
	...
	e.jo_posx, e.jo_posy = memory.readdwordsigned(0x020fcba4), memory.readdwordsigned(0x020fcba8)
	e.jo_hitx1, e.jo_hity1 = memory.readwordsigned(0x0213296e), memory.readwordsigned(0x02132970)
	e.jo_hitx2, e.jo_hity2 = memory.readwordsigned(0x02132972), memory.readwordsigned(0x02132974)
	...
	e.ch_posx, e.ch_posy = memory.readdwordsigned(0x020fcd04), memory.readdwordsigned(0x020fcd08)
	e.ch_hitx1, e.ch_hity1 = memory.readwordsigned(0x02132982), memory.readwordsigned(0x02132984)
	e.ch_hitx2, e.ch_hity2 = memory.readwordsigned(0x02132986), memory.readwordsigned(0x02132988)
